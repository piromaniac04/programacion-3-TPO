...
def main():
    ...
    #         print(f"Distancia mínima de {i} a {j}: {floyd[i][j]}")
    #         print(f"Camino: {caminos[i][j]}")
    ...
    for nodo in nodosEntrega:
        if nodo in dicNodosCantidad:
            dicNodosCantidad[nodo]+=1
        else:
            dicNodosCantidad[nodo]=1
    

    cantidadPaquetesEnDeposito=len(problema.paquetes)
    capacidadActual=problema.capacidad_camion
    cantidadPaquetesEnDeposito-=capacidadActual
    
    
    # print(cantidadPaquetesEnDeposito)
    # print(capacidadActual)
    print(dicNodosCantidad)
    # n = len(floyd)
    # for i in range(n):
    #     print(f"Desde el nodo 13: hacia el nodo {i} la distancia minima es {floyd[13][i]} y el camino es {caminos[13][i]}")
    ...
    # print("\nMatriz de distancias (desde -> hasta):")
    # # encabezado con ids
    # print("      ", end="")
    # for j in range(n):
    #     print(f"{j:7d} ", end="")
